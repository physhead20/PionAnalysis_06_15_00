...
// Sat Feb 11 04:54:23 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PionMC_06_15_00.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[95];   //[nclus]
   Double_t        clusterttick[95];   //[nclus]
   Double_t        cluendwire[95];   //[nclus]
   Double_t        cluendtick[95];   //[nclus]
   Int_t           cluplane[95];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1387];   //[nhits]
   Int_t           hit_wire[1387];   //[nhits]
   Int_t           hit_channel[1387];   //[nhits]
   Double_t        hit_peakT[1387];   //[nhits]
   Double_t        hit_charge[1387];   //[nhits]
   Double_t        hit_ph[1387];   //[nhits]
   Double_t        hit_tstart[1387];   //[nhits]
   Double_t        hit_tend[1387];   //[nhits]
   Int_t           hit_trkid[1387];   //[nhits]
   Int_t           hit_trkkey[1387];   //[nhits]
   Int_t           hit_clukey[1387];   //[nhits]
   Int_t           hit_pk[1387];   //[nhits]
   Int_t           hit_t[1387];   //[nhits]
   Int_t           hit_ch[1387];   //[nhits]
   Int_t           hit_fwhh[1387];   //[nhits]
   Double_t        hit_rms[1387];   //[nhits]
   Double_t        hit_nelec[1387];   //[nhits]
   Double_t        hit_energy[1387];   //[nhits]
   Float_t         hit_dQds[1387];   //[nhits]
   Float_t         hit_dEds[1387];   //[nhits]
   Float_t         hit_ds[1387];   //[nhits]
   Float_t         hit_resrange[1387];   //[nhits]
   Float_t         hit_x[1387];   //[nhits]
   Float_t         hit_y[1387];   //[nhits]
   Float_t         hit_z[1387];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[3792];   //[maxTrackIDE]
   Double_t        IDEPos[3792][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[373];   //[geant_list_size]
   Double_t        Eng[373];   //[geant_list_size]
   Double_t        Px[373];   //[geant_list_size]
   Double_t        Py[373];   //[geant_list_size]
   Double_t        Pz[373];   //[geant_list_size]
   Double_t        EndEng[373];   //[geant_list_size]
   Double_t        EndPx[373];   //[geant_list_size]
   Double_t        EndPy[373];   //[geant_list_size]
   Double_t        EndPz[373];   //[geant_list_size]
   Double_t        StartPointx[373];   //[geant_list_size]
   Double_t        StartPointy[373];   //[geant_list_size]
   Double_t        StartPointz[373];   //[geant_list_size]
   Double_t        EndPointx[373];   //[geant_list_size]
   Double_t        EndPointy[373];   //[geant_list_size]
   Double_t        EndPointz[373];   //[geant_list_size]
   Int_t           Process[373];   //[geant_list_size]
   Int_t           NumberDaughters[373];   //[geant_list_size]
   Int_t           Mother[373];   //[geant_list_size]
   Int_t           TrackId[373];   //[geant_list_size]
   Int_t           process_primary[373];   //[geant_list_size]
...
#ifdef PionMC_cxx
PionMC::PionMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PionMC_06_15_00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PionMC_06_15_00.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PionMC_06_15_00.root:/anatree");
...
Int_t PionMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PionMC::LoadTree(Long64_t entry)
{
...
void PionMC::Show(Long64_t entry)
{
...
Int_t PionMC::Cut(Long64_t entry)
{
