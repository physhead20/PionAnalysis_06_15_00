...
// Sat Apr  8 05:57:31 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/Pion_DDMC_AnaTree_SmallSample.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1051];   //[nhits]
   Int_t           hit_wire[1051];   //[nhits]
   Int_t           hit_channel[1051];   //[nhits]
   Double_t        hit_peakT[1051];   //[nhits]
   Double_t        hit_charge[1051];   //[nhits]
   Double_t        hit_ph[1051];   //[nhits]
   Double_t        hit_tstart[1051];   //[nhits]
   Double_t        hit_tend[1051];   //[nhits]
   Int_t           hit_trkid[1051];   //[nhits]
   Int_t           hit_trkkey[1051];   //[nhits]
   Int_t           hit_clukey[1051];   //[nhits]
   Int_t           hit_pk[1051];   //[nhits]
   Int_t           hit_t[1051];   //[nhits]
   Int_t           hit_ch[1051];   //[nhits]
   Int_t           hit_fwhh[1051];   //[nhits]
   Double_t        hit_rms[1051];   //[nhits]
   Double_t        hit_nelec[1051];   //[nhits]
   Double_t        hit_energy[1051];   //[nhits]
   Float_t         hit_dQds[1051];   //[nhits]
   Float_t         hit_dEds[1051];   //[nhits]
   Float_t         hit_ds[1051];   //[nhits]
   Float_t         hit_resrange[1051];   //[nhits]
   Float_t         hit_x[1051];   //[nhits]
   Float_t         hit_y[1051];   //[nhits]
   Float_t         hit_z[1051];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[3759];   //[maxTrackIDE]
   Double_t        IDEPos[3759][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[257];   //[geant_list_size]
   Double_t        Eng[257];   //[geant_list_size]
   Double_t        Px[257];   //[geant_list_size]
   Double_t        Py[257];   //[geant_list_size]
   Double_t        Pz[257];   //[geant_list_size]
   Double_t        EndEng[257];   //[geant_list_size]
   Double_t        EndPx[257];   //[geant_list_size]
   Double_t        EndPy[257];   //[geant_list_size]
   Double_t        EndPz[257];   //[geant_list_size]
   Double_t        StartPointx[257];   //[geant_list_size]
   Double_t        StartPointy[257];   //[geant_list_size]
   Double_t        StartPointz[257];   //[geant_list_size]
   Double_t        EndPointx[257];   //[geant_list_size]
   Double_t        EndPointy[257];   //[geant_list_size]
   Double_t        EndPointz[257];   //[geant_list_size]
   Int_t           Process[257];   //[geant_list_size]
   Int_t           NumberDaughters[257];   //[geant_list_size]
   Int_t           Mother[257];   //[geant_list_size]
   Int_t           TrackId[257];   //[geant_list_size]
   Int_t           process_primary[257];   //[geant_list_size]
...
#ifdef PionMCDD_cxx
PionMCDD::PionMCDD(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/Pion_DDMC_AnaTree_SmallSample.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/Pion_DDMC_AnaTree_SmallSample.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/Pion_DDMC_AnaTree_SmallSample.root:/anatree");
...
Int_t PionMCDD::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PionMCDD::LoadTree(Long64_t entry)
{
...
void PionMCDD::Show(Long64_t entry)
{
...
Int_t PionMCDD::Cut(Long64_t entry)
{
