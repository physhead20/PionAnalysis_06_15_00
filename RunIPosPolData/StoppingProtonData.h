...
// Fri Apr  7 06:07:00 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/RunIPosPol_AnaTree_06_15_00.root
//////////////////////////////////////////////////////////

#ifndef StoppingProtonData_h
#define StoppingProtonData_h
...
public :
   ...
   StoppingProtonData(TTree *tree=0);
   virtual ~StoppingProtonData();
...
#ifdef StoppingProtonData_cxx
StoppingProtonData::StoppingProtonData(TTree *tree) : fChain(0) 
{
...
StoppingProtonData::~StoppingProtonData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t StoppingProtonData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t StoppingProtonData::LoadTree(Long64_t entry)
{
...
void StoppingProtonData::Init(TTree *tree)
{
...
Bool_t StoppingProtonData::Notify()
{
...
void StoppingProtonData::Show(Long64_t entry)
{
...
Int_t StoppingProtonData::Cut(Long64_t entry)
{
...
#endif // #ifdef StoppingProtonData_cxx
