#define Data_Protons_cxx
#include "Data_Protons.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
#include <TVector3.h>
// #########################################################################################
// ### This is the macro for data analysis of the proton sample based on the latest cuts ###
// ###        using Run I Positive Polarity in LArIATsoft version 06_15_00               ###
// #########################################################################################
...
/////////////////////////////////// "Matched Track" dE/dX in Q1 /////////////////////////////////////////////////////
TH1D *hdataStoppedProtondEdXQ1 = new TH1D("hdataStoppedProtondEdXQ1", "Matched Track dE/dX Q1", 200, 0, 50);

/////////////////////////////////// "Matched Track" dE/dX in Q2 /////////////////////////////////////////////////////
TH1D *hdataStoppedProtondEdXQ2 = new TH1D("hdataStoppedProtondEdXQ2", "Matched Track dE/dX Q2", 200, 0, 50);

/////////////////////////////////// "Matched Track" dE/dX in Q3 /////////////////////////////////////////////////////
TH1D *hdataStoppedProtondEdXQ3 = new TH1D("hdataStoppedProtondEdXQ3", "Matched Track dE/dX Q2", 200, 0, 50);

/////////////////////////////////// "Matched Track" dE/dX in Q4 /////////////////////////////////////////////////////
TH1D *hdataStoppedProtondEdXQ4 = new TH1D("hdataStoppedProtondEdXQ4", "Matched Track dE/dX Q2", 200, 0, 50);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   for(int nTPCtrk = 0; nTPCtrk < ntracks_reco; nTPCtrk++)
	 ...
	 hStoppedProtondEdXvsRR->Fill(DataResRange[npoints], DatadEdX[npoints]);
      
         hStoppedProtondEdX->Fill(DatadEdX[npoints]);
         hStoppedProtonRR->Fill(DataResRange[npoints]);
         hStoppedProtonTrkPitch->Fill(DataSptPitch[npoints]);
	 ...
	 if(DataSptsZ[npoints] > 0 && DataSptsZ[npoints] < 22.5){hdataStoppedProtondEdXQ1->Fill(DatadEdX[npoints]);}
	 if(DataSptsZ[npoints] > 22.5 && DataSptsZ[npoints] < 45){hdataStoppedProtondEdXQ2->Fill(DatadEdX[npoints]);}
	 if(DataSptsZ[npoints] > 45 && DataSptsZ[npoints] < 67.5){hdataStoppedProtondEdXQ3->Fill(DatadEdX[npoints]);}
	 if(DataSptsZ[npoints] > 67.5 && DataSptsZ[npoints] < 90){hdataStoppedProtondEdXQ4->Fill(DatadEdX[npoints]);}
...
hdataStoppedProtondEdXQ1->Write();
