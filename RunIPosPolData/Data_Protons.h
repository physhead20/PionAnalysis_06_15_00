...
// Fri Feb 17 08:24:56 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/RunIPosPol_AnaTree_06_15_00.root
//////////////////////////////////////////////////////////

#ifndef Data_Protons_h
#define Data_Protons_h
...
public :
   ...
   Data_Protons(TTree *tree=0);
   virtual ~Data_Protons();
...
#ifdef Data_Protons_cxx
Data_Protons::Data_Protons(TTree *tree) : fChain(0) 
{
...
Data_Protons::~Data_Protons()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Data_Protons::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Data_Protons::LoadTree(Long64_t entry)
{
...
void Data_Protons::Init(TTree *tree)
{
...
void Data_Protons::Show(Long64_t entry)
{
...
Int_t Data_Protons::Cut(Long64_t entry)
{
