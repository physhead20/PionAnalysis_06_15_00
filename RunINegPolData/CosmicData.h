...
// Sat Feb 11 07:50:25 2017 by ROOT version 5.34/36
...
#ifdef CosmicData_cxx
CosmicData::CosmicData(TTree *tree) : fChain(0) 
{
...
Int_t CosmicData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CosmicData::LoadTree(Long64_t entry)
{
...
void CosmicData::Init(TTree *tree)
{
...
void CosmicData::Show(Long64_t entry)
{
...
Int_t CosmicData::Cut(Long64_t entry)
{
