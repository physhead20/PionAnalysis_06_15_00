...
// Wed Mar  8 18:18:05 2017 by ROOT version 5.34/36
...
#ifdef BeamTracks_cxx
BeamTracks::BeamTracks(TTree *tree) : fChain(0) 
{
...
Int_t BeamTracks::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BeamTracks::LoadTree(Long64_t entry)
{
...
void BeamTracks::Init(TTree *tree)
{
...
void BeamTracks::Show(Long64_t entry)
{
...
Int_t BeamTracks::Cut(Long64_t entry)
{
