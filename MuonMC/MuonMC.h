...
// Sat Feb 11 06:20:25 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/MuonMC_06_15_00.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[51];   //[nclus]
   Double_t        clusterttick[51];   //[nclus]
   Double_t        cluendwire[51];   //[nclus]
   Double_t        cluendtick[51];   //[nclus]
   Int_t           cluplane[51];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           trkWCtoTPCMatch[15];   //[ntracks_reco]
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[974];   //[nhits]
   Int_t           hit_wire[974];   //[nhits]
   Int_t           hit_channel[974];   //[nhits]
   Double_t        hit_peakT[974];   //[nhits]
   Double_t        hit_charge[974];   //[nhits]
   Double_t        hit_ph[974];   //[nhits]
   Double_t        hit_tstart[974];   //[nhits]
   Double_t        hit_tend[974];   //[nhits]
   Int_t           hit_trkid[974];   //[nhits]
   Int_t           hit_trkkey[974];   //[nhits]
   Int_t           hit_clukey[974];   //[nhits]
   Int_t           hit_pk[974];   //[nhits]
   Int_t           hit_t[974];   //[nhits]
   Int_t           hit_ch[974];   //[nhits]
   Int_t           hit_fwhh[974];   //[nhits]
   Double_t        hit_rms[974];   //[nhits]
   Double_t        hit_nelec[974];   //[nhits]
   Double_t        hit_energy[974];   //[nhits]
   Float_t         hit_dQds[974];   //[nhits]
   Float_t         hit_dEds[974];   //[nhits]
   Float_t         hit_ds[974];   //[nhits]
   Float_t         hit_resrange[974];   //[nhits]
   Float_t         hit_x[974];   //[nhits]
   Float_t         hit_y[974];   //[nhits]
   Float_t         hit_z[974];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[3785];   //[maxTrackIDE]
   Double_t        IDEPos[3785][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[106];   //[geant_list_size]
   Double_t        Eng[106];   //[geant_list_size]
   Double_t        Px[106];   //[geant_list_size]
   Double_t        Py[106];   //[geant_list_size]
   Double_t        Pz[106];   //[geant_list_size]
   Double_t        EndEng[106];   //[geant_list_size]
   Double_t        EndPx[106];   //[geant_list_size]
   Double_t        EndPy[106];   //[geant_list_size]
   Double_t        EndPz[106];   //[geant_list_size]
   Double_t        StartPointx[106];   //[geant_list_size]
   Double_t        StartPointy[106];   //[geant_list_size]
   Double_t        StartPointz[106];   //[geant_list_size]
   Double_t        EndPointx[106];   //[geant_list_size]
   Double_t        EndPointy[106];   //[geant_list_size]
   Double_t        EndPointz[106];   //[geant_list_size]
   Int_t           Process[106];   //[geant_list_size]
   Int_t           NumberDaughters[106];   //[geant_list_size]
   Int_t           Mother[106];   //[geant_list_size]
   Int_t           TrackId[106];   //[geant_list_size]
   Int_t           process_primary[106];   //[geant_list_size]
...
#ifdef MuonMC_cxx
MuonMC::MuonMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/MuonMC_06_15_00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/MuonMC_06_15_00.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/MuonMC_06_15_00.root:/anatree");
...
Int_t MuonMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MuonMC::LoadTree(Long64_t entry)
{
...
void MuonMC::Show(Long64_t entry)
{
...
Int_t MuonMC::Cut(Long64_t entry)
{
