...
// Sun Jun 11 07:48:07 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PickyTrack_PiMuE_PosPol_RunII_06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIIPos_h
#define PickyTrk_RunIIPos_h
...
public :
   ...
   PickyTrk_RunIIPos(TTree *tree=0);
   virtual ~PickyTrk_RunIIPos();
...
#ifdef PickyTrk_RunIIPos_cxx
PickyTrk_RunIIPos::PickyTrk_RunIIPos(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PickyTrack_PiMuE_PosPol_RunII_06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PickyTrack_PiMuE_PosPol_RunII_06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PickyTrack_PiMuE_PosPol_RunII_06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIIPos::~PickyTrk_RunIIPos()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIIPos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIIPos::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIIPos::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIIPos::Notify()
{
...
void PickyTrk_RunIIPos::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIIPos::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIIPos_cxx
