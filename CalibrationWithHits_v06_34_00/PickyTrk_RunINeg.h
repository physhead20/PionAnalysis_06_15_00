...
// Sat Jun 10 10:21:12 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PickyTrack_PiMuE_NegPol_RunI_06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunINeg_h
#define PickyTrk_RunINeg_h
...
public :
   ...
   PickyTrk_RunINeg(TTree *tree=0);
   virtual ~PickyTrk_RunINeg();
...
#ifdef PickyTrk_RunINeg_cxx
PickyTrk_RunINeg::PickyTrk_RunINeg(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PickyTrack_PiMuE_NegPol_RunI_06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PickyTrack_PiMuE_NegPol_RunI_06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PickyTrack_PiMuE_NegPol_RunI_06_34_01_anatree.root:/anatree");
...
PickyTrk_RunINeg::~PickyTrk_RunINeg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunINeg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunINeg::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunINeg::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunINeg::Notify()
{
...
void PickyTrk_RunINeg::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunINeg::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunINeg_cxx
