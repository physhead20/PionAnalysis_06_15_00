...
// Sun Jun 11 07:10:04 2017 by ROOT version 6.08/06
// from TTree anatree/analysis tree
// found on file: HighYield_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree_v2.root
//////////////////////////////////////////////////////////

#ifndef HYTrk_RunINeg_h
#define HYTrk_RunINeg_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   HYTrk_RunINeg(TTree *tree=0);
   virtual ~HYTrk_RunINeg();
...
#ifdef HYTrk_RunINeg_cxx
HYTrk_RunINeg::HYTrk_RunINeg(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("HighYield_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree_v2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("HighYield_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree_v2.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("HighYield_RunI_PiMuE_NegPol_Reco_v06_34_01_anatree_v2.root:/anatree");
...
HYTrk_RunINeg::~HYTrk_RunINeg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HYTrk_RunINeg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HYTrk_RunINeg::LoadTree(Long64_t entry)
{
...
void HYTrk_RunINeg::Init(TTree *tree)
{
...
void HYTrk_RunINeg::Show(Long64_t entry)
{
...
Int_t HYTrk_RunINeg::Cut(Long64_t entry)
{
