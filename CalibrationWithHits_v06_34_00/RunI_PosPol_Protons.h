...
// Thu Jun  8 17:21:15 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PickyTrack_Proton_PosPol_Run1_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef RunI_PosPol_Protons_h
#define RunI_PosPol_Protons_h
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[608];   //[nclus]
   Double_t        clusterttick[608];   //[nclus]
   Double_t        cluendwire[608];   //[nclus]
   Double_t        cluendtick[608];   //[nclus]
   Int_t           cluplane[608];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[116];   //[ntracks_reco]
   Double_t        trkvtxy[116];   //[ntracks_reco]
   Double_t        trkvtxz[116];   //[ntracks_reco]
   Double_t        trkendx[116];   //[ntracks_reco]
   Double_t        trkendy[116];   //[ntracks_reco]
   Double_t        trkendz[116];   //[ntracks_reco]
   Double_t        trkstartdcosx[116];   //[ntracks_reco]
   Double_t        trkstartdcosy[116];   //[ntracks_reco]
   Double_t        trkstartdcosz[116];   //[ntracks_reco]
   Double_t        trkenddcosx[116];   //[ntracks_reco]
   Double_t        trkenddcosy[116];   //[ntracks_reco]
   Double_t        trkenddcosz[116];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[116];   //[ntracks_reco]
   Double_t        trklength[116];   //[ntracks_reco]
   Double_t        trkmomrange[116];   //[ntracks_reco]
   Double_t        trkmommschi2[116];   //[ntracks_reco]
   Double_t        trkmommsllhd[116];   //[ntracks_reco]
   Int_t           ntrkhits[116];   //[ntracks_reco]
   Double_t        trkx[116][1000];   //[ntracks_reco]
   Double_t        trky[116][1000];   //[ntracks_reco]
   Double_t        trkz[116][1000];   //[ntracks_reco]
   Double_t        trkpitch[116][2];   //[ntracks_reco]
   Int_t           trkhits[116][2];   //[ntracks_reco]
   Double_t        trkdedx[116][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[116][2][1000];   //[ntracks_reco]
   Double_t        trkrr[116][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[116][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[116][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[116][2];   //[ntracks_reco]
   Double_t        trkpida[116][2];   //[ntracks_reco]
   Int_t           nTrajPoint[116];   //[ntracks_reco]
   Double_t        pHat0_X[116][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[116][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[116][1000];   //[ntracks_reco]
   Double_t        trjPt_X[116][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[116][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[116][1000];   //[ntracks_reco]
   Int_t           trkg4id[116];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[18945];   //[nhits]
   Int_t           hit_wire[18945];   //[nhits]
   Int_t           hit_channel[18945];   //[nhits]
   Double_t        hit_peakT[18945];   //[nhits]
   Double_t        hit_charge[18945];   //[nhits]
   Double_t        hit_ph[18945];   //[nhits]
   Double_t        hit_tstart[18945];   //[nhits]
   Double_t        hit_tend[18945];   //[nhits]
   Int_t           hit_trkid[18945];   //[nhits]
   Int_t           hit_trkkey[18945];   //[nhits]
   Int_t           hit_clukey[18945];   //[nhits]
   Int_t           hit_pk[18945];   //[nhits]
   Int_t           hit_t[18945];   //[nhits]
   Int_t           hit_ch[18945];   //[nhits]
   Int_t           hit_fwhh[18945];   //[nhits]
   Double_t        hit_rms[18945];   //[nhits]
   Double_t        hit_nelec[18945];   //[nhits]
   Double_t        hit_energy[18945];   //[nhits]
   Float_t         hit_dQds[18945];   //[nhits]
   Float_t         hit_dEds[18945];   //[nhits]
   Float_t         hit_ds[18945];   //[nhits]
   Float_t         hit_resrange[18945];   //[nhits]
   Float_t         hit_x[18945];   //[nhits]
   Float_t         hit_y[18945];   //[nhits]
   Float_t         hit_z[18945];   //[nhits]
   Int_t           nwctrks;
   ...
   RunI_PosPol_Protons(TTree *tree=0);
   virtual ~RunI_PosPol_Protons();
...
#ifdef RunI_PosPol_Protons_cxx
RunI_PosPol_Protons::RunI_PosPol_Protons(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PickyTrack_Proton_PosPol_Run1_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PickyTrack_Proton_PosPol_Run1_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PickyTrack_Proton_PosPol_Run1_Reco_v06_34_01_anatree.root:/anatree");
...
RunI_PosPol_Protons::~RunI_PosPol_Protons()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RunI_PosPol_Protons::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RunI_PosPol_Protons::LoadTree(Long64_t entry)
{
...
void RunI_PosPol_Protons::Init(TTree *tree)
{
...
Bool_t RunI_PosPol_Protons::Notify()
{
...
void RunI_PosPol_Protons::Show(Long64_t entry)
{
...
Int_t RunI_PosPol_Protons::Cut(Long64_t entry)
{
...
#endif // #ifdef RunI_PosPol_Protons_cxx
