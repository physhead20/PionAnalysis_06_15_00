...
// Sat Jun 10 11:56:48 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PickyTrack_PiMuE_PosPol_RunI_06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef PickyTrk_RunIPos_h
#define PickyTrk_RunIPos_h
...
public :
   ...
   PickyTrk_RunIPos(TTree *tree=0);
   virtual ~PickyTrk_RunIPos();
...
#ifdef PickyTrk_RunIPos_cxx
PickyTrk_RunIPos::PickyTrk_RunIPos(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PickyTrack_PiMuE_PosPol_RunI_06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PickyTrack_PiMuE_PosPol_RunI_06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PickyTrack_PiMuE_PosPol_RunI_06_34_01_anatree.root:/anatree");
...
PickyTrk_RunIPos::~PickyTrk_RunIPos()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PickyTrk_RunIPos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PickyTrk_RunIPos::LoadTree(Long64_t entry)
{
...
void PickyTrk_RunIPos::Init(TTree *tree)
{
...
Bool_t PickyTrk_RunIPos::Notify()
{
...
void PickyTrk_RunIPos::Show(Long64_t entry)
{
...
Int_t PickyTrk_RunIPos::Cut(Long64_t entry)
{
...
#endif // #ifdef PickyTrk_RunIPos_cxx
