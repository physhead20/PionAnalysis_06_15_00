...
// Sat Feb 11 06:56:13 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PhotonMC_06_15_00.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[108];   //[nclus]
   Double_t        clusterttick[108];   //[nclus]
   Double_t        cluendwire[108];   //[nclus]
   Double_t        cluendtick[108];   //[nclus]
   Int_t           cluplane[108];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[38];   //[ntracks_reco]
   Double_t        trkvtxy[38];   //[ntracks_reco]
   Double_t        trkvtxz[38];   //[ntracks_reco]
   Double_t        trkendx[38];   //[ntracks_reco]
   Double_t        trkendy[38];   //[ntracks_reco]
   Double_t        trkendz[38];   //[ntracks_reco]
   Double_t        trkstartdcosx[38];   //[ntracks_reco]
   Double_t        trkstartdcosy[38];   //[ntracks_reco]
   Double_t        trkstartdcosz[38];   //[ntracks_reco]
   Double_t        trkenddcosx[38];   //[ntracks_reco]
   Double_t        trkenddcosy[38];   //[ntracks_reco]
   Double_t        trkenddcosz[38];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[38];   //[ntracks_reco]
   Double_t        trklength[38];   //[ntracks_reco]
   Double_t        trkmomrange[38];   //[ntracks_reco]
   Double_t        trkmommschi2[38];   //[ntracks_reco]
   Double_t        trkmommsllhd[38];   //[ntracks_reco]
   Int_t           ntrkhits[38];   //[ntracks_reco]
   Double_t        trkx[38][1000];   //[ntracks_reco]
   Double_t        trky[38][1000];   //[ntracks_reco]
   Double_t        trkz[38][1000];   //[ntracks_reco]
   Double_t        trkpitch[38][2];   //[ntracks_reco]
   Int_t           trkhits[38][2];   //[ntracks_reco]
   Double_t        trkdedx[38][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[38][2][1000];   //[ntracks_reco]
   Double_t        trkrr[38][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[38][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[38][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[38][2];   //[ntracks_reco]
   Double_t        trkpida[38][2];   //[ntracks_reco]
   Int_t           nTrajPoint[38];   //[ntracks_reco]
   Double_t        pHat0_X[38][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[38][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[38][1000];   //[ntracks_reco]
   Double_t        trjPt_X[38][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[38][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[38][1000];   //[ntracks_reco]
   Int_t           trkg4id[38];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1726];   //[nhits]
   Int_t           hit_wire[1726];   //[nhits]
   Int_t           hit_channel[1726];   //[nhits]
   Double_t        hit_peakT[1726];   //[nhits]
   Double_t        hit_charge[1726];   //[nhits]
   Double_t        hit_ph[1726];   //[nhits]
   Double_t        hit_tstart[1726];   //[nhits]
   Double_t        hit_tend[1726];   //[nhits]
   Int_t           hit_trkid[1726];   //[nhits]
   Int_t           hit_trkkey[1726];   //[nhits]
   Int_t           hit_clukey[1726];   //[nhits]
   Int_t           hit_pk[1726];   //[nhits]
   Int_t           hit_t[1726];   //[nhits]
   Int_t           hit_ch[1726];   //[nhits]
   Int_t           hit_fwhh[1726];   //[nhits]
   Double_t        hit_rms[1726];   //[nhits]
   Double_t        hit_nelec[1726];   //[nhits]
   Double_t        hit_energy[1726];   //[nhits]
   Float_t         hit_dQds[1726];   //[nhits]
   Float_t         hit_dEds[1726];   //[nhits]
   Float_t         hit_ds[1726];   //[nhits]
   Float_t         hit_resrange[1726];   //[nhits]
   Float_t         hit_x[1726];   //[nhits]
   Float_t         hit_y[1726];   //[nhits]
   Float_t         hit_z[1726];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           pdg[3148];   //[geant_list_size]
   Double_t        Eng[3148];   //[geant_list_size]
   Double_t        Px[3148];   //[geant_list_size]
   Double_t        Py[3148];   //[geant_list_size]
   Double_t        Pz[3148];   //[geant_list_size]
   Double_t        EndEng[3148];   //[geant_list_size]
   Double_t        EndPx[3148];   //[geant_list_size]
   Double_t        EndPy[3148];   //[geant_list_size]
   Double_t        EndPz[3148];   //[geant_list_size]
   Double_t        StartPointx[3148];   //[geant_list_size]
   Double_t        StartPointy[3148];   //[geant_list_size]
   Double_t        StartPointz[3148];   //[geant_list_size]
   Double_t        EndPointx[3148];   //[geant_list_size]
   Double_t        EndPointy[3148];   //[geant_list_size]
   Double_t        EndPointz[3148];   //[geant_list_size]
   Int_t           Process[3148];   //[geant_list_size]
   Int_t           NumberDaughters[3148];   //[geant_list_size]
   Int_t           Mother[3148];   //[geant_list_size]
   Int_t           TrackId[3148];   //[geant_list_size]
   Int_t           process_primary[3148];   //[geant_list_size]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PhotonMC_06_15_00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PhotonMC_06_15_00.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PhotonMC_06_15_00.root:/anatree");
