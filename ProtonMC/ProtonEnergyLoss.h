...
// Tue Apr  4 17:38:01 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/ProtonMC_06_15_00.root
//////////////////////////////////////////////////////////

#ifndef ProtonEnergyLoss_h
#define ProtonEnergyLoss_h
...
public :
   ...
   ProtonEnergyLoss(TTree *tree=0);
   virtual ~ProtonEnergyLoss();
...
#ifdef ProtonEnergyLoss_cxx
ProtonEnergyLoss::ProtonEnergyLoss(TTree *tree) : fChain(0) 
{
...
ProtonEnergyLoss::~ProtonEnergyLoss()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ProtonEnergyLoss::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ProtonEnergyLoss::LoadTree(Long64_t entry)
{
...
void ProtonEnergyLoss::Init(TTree *tree)
{
...
Bool_t ProtonEnergyLoss::Notify()
{
...
void ProtonEnergyLoss::Show(Long64_t entry)
{
...
Int_t ProtonEnergyLoss::Cut(Long64_t entry)
{
...
#endif // #ifdef ProtonEnergyLoss_cxx
