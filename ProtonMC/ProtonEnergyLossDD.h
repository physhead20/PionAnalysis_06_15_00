...
// Sat Apr  8 10:09:05 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/ProtonRunI_DDMC_AnaTree.root
//////////////////////////////////////////////////////////

#ifndef ProtonEnergyLossDD_h
#define ProtonEnergyLossDD_h
...
public :
   ...
   ProtonEnergyLossDD(TTree *tree=0);
   virtual ~ProtonEnergyLossDD();
...
#ifdef ProtonEnergyLossDD_cxx
ProtonEnergyLossDD::ProtonEnergyLossDD(TTree *tree) : fChain(0) 
{
...
ProtonEnergyLossDD::~ProtonEnergyLossDD()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ProtonEnergyLossDD::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ProtonEnergyLossDD::LoadTree(Long64_t entry)
{
...
void ProtonEnergyLossDD::Init(TTree *tree)
{
...
Bool_t ProtonEnergyLossDD::Notify()
{
...
void ProtonEnergyLossDD::Show(Long64_t entry)
{
...
Int_t ProtonEnergyLossDD::Cut(Long64_t entry)
{
...
#endif // #ifdef ProtonEnergyLossDD_cxx
