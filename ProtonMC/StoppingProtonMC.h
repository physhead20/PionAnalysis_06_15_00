...
// Fri Feb 17 17:56:36 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/ProtonMC_06_15_00.root
//////////////////////////////////////////////////////////

#ifndef StoppingProtonMC_h
#define StoppingProtonMC_h
...
public :
   ...
   Int_t           trkWCtoTPCMatch[17];   //[ntracks_reco]
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1067];   //[nhits]
   Int_t           hit_wire[1067];   //[nhits]
   Int_t           hit_channel[1067];   //[nhits]
   Double_t        hit_peakT[1067];   //[nhits]
   Double_t        hit_charge[1067];   //[nhits]
   Double_t        hit_ph[1067];   //[nhits]
   Double_t        hit_tstart[1067];   //[nhits]
   Double_t        hit_tend[1067];   //[nhits]
   Int_t           hit_trkid[1067];   //[nhits]
   Int_t           hit_trkkey[1067];   //[nhits]
   Int_t           hit_clukey[1067];   //[nhits]
   Int_t           hit_pk[1067];   //[nhits]
   Int_t           hit_t[1067];   //[nhits]
   Int_t           hit_ch[1067];   //[nhits]
   Int_t           hit_fwhh[1067];   //[nhits]
   Double_t        hit_rms[1067];   //[nhits]
   Double_t        hit_nelec[1067];   //[nhits]
   Double_t        hit_energy[1067];   //[nhits]
   Float_t         hit_dQds[1067];   //[nhits]
   Float_t         hit_dEds[1067];   //[nhits]
   Float_t         hit_ds[1067];   //[nhits]
   Float_t         hit_resrange[1067];   //[nhits]
   Float_t         hit_x[1067];   //[nhits]
   Float_t         hit_y[1067];   //[nhits]
   Float_t         hit_z[1067];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[3107];   //[maxTrackIDE]
   Double_t        IDEPos[3107][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[262];   //[geant_list_size]
   Double_t        Eng[262];   //[geant_list_size]
   Double_t        Px[262];   //[geant_list_size]
   Double_t        Py[262];   //[geant_list_size]
   Double_t        Pz[262];   //[geant_list_size]
   Double_t        EndEng[262];   //[geant_list_size]
   Double_t        EndPx[262];   //[geant_list_size]
   Double_t        EndPy[262];   //[geant_list_size]
   Double_t        EndPz[262];   //[geant_list_size]
   Double_t        StartPointx[262];   //[geant_list_size]
   Double_t        StartPointy[262];   //[geant_list_size]
   Double_t        StartPointz[262];   //[geant_list_size]
   Double_t        EndPointx[262];   //[geant_list_size]
   Double_t        EndPointy[262];   //[geant_list_size]
   Double_t        EndPointz[262];   //[geant_list_size]
   Int_t           Process[262];   //[geant_list_size]
   Int_t           NumberDaughters[262];   //[geant_list_size]
   Int_t           Mother[262];   //[geant_list_size]
   Int_t           TrackId[262];   //[geant_list_size]
   Int_t           process_primary[262];   //[geant_list_size]
   ...
   StoppingProtonMC(TTree *tree=0);
   virtual ~StoppingProtonMC();
...
#ifdef StoppingProtonMC_cxx
StoppingProtonMC::StoppingProtonMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/ProtonMC_06_15_00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/ProtonMC_06_15_00.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/ProtonMC_06_15_00.root:/anatree");
...
StoppingProtonMC::~StoppingProtonMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t StoppingProtonMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t StoppingProtonMC::LoadTree(Long64_t entry)
{
...
void StoppingProtonMC::Init(TTree *tree)
{
...
Bool_t StoppingProtonMC::Notify()
{
...
void StoppingProtonMC::Show(Long64_t entry)
{
...
Int_t StoppingProtonMC::Cut(Long64_t entry)
{
...
#endif // #ifdef StoppingProtonMC_cxx
