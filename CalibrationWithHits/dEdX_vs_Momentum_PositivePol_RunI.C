...
// ### Collection Plane ###
// ########################
//TFile *f1 = new TFile("./TJCalibrationMethod_RunINegPol_DefaultCollection_notThroughGoing.root");
//TFile *f1 = new TFile("./TJCalibrationMethod_RunINegPol_0.058Collection_notThroughGoing.root");
//TFile *f1 = new TFile("./TJCalibrationMethod_RunINegPol_0.052Collection_notThroughGoing.root");

//TFile *f1 = new TFile("./TJCalibrationMethod_RunIPosPol_DefaultCollection_ThroughGoing.root");
TFile *f1 = new TFile("./TJCalibrationMethod_RunIPosPol_0.055Collection_ThroughGoing.root");
