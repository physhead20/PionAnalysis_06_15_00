...
TFile *f1 = new TFile("./TJCalibrationMethod_RunIPosPol_0.055Collection_Proton.root");

//TFile *f1 = new TFile("./TJCalibrationMethod_RunIProtonMC_0.101Collection_NotThroughGoing.root");
