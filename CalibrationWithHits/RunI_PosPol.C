#define RunI_PosPol_cxx
#include "RunI_PosPol.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
TFile myfile("./TJCalibrationMethod_RunIPosPol_0.055Collection_ThroughGoing.root","RECREATE");
