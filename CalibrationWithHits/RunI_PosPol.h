...
#ifdef RunI_PosPol_cxx
RunI_PosPol::RunI_PosPol(TTree *tree) : fChain(0) 
{
...
RunI_PosPol::~RunI_PosPol()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RunI_PosPol::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RunI_PosPol::LoadTree(Long64_t entry)
{
...
void RunI_PosPol::Init(TTree *tree)
{
...
void RunI_PosPol::Show(Long64_t entry)
{
...
Int_t RunI_PosPol::Cut(Long64_t entry)
{
