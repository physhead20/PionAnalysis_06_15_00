#define RunI_PionNegMC_cxx
#include "RunI_PionNegMC.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
TFile myfile("./TJCalibrationMethod_RunIPionMC_0.094Induction_ThroughGoing.root","RECREATE");
