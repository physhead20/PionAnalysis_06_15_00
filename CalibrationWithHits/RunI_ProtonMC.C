#define RunI_ProtonMC_cxx
#include "RunI_ProtonMC.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
TFile myfile("./TJCalibrationMethod_RunIProtonMC_0.101Collection_NotThroughGoing.root","RECREATE");
