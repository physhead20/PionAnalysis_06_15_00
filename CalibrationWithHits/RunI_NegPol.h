...
// Thu May 25 21:19:14 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/RunINegPol_AnaTree_06_15_00.root
//////////////////////////////////////////////////////////

#ifndef RunI_NegPol_h
#define RunI_NegPol_h
...
#ifdef RunI_NegPol_cxx
RunI_NegPol::RunI_NegPol(TTree *tree) : fChain(0) 
{
...
RunI_NegPol::~RunI_NegPol()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RunI_NegPol::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RunI_NegPol::LoadTree(Long64_t entry)
{
...
void RunI_NegPol::Init(TTree *tree)
{
...
void RunI_NegPol::Show(Long64_t entry)
{
...
Int_t RunI_NegPol::Cut(Long64_t entry)
{
