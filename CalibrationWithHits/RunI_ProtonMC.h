...
// Thu Jun  1 09:19:16 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/ProtonRunI_DDMC_AnaTree.root
//////////////////////////////////////////////////////////

#ifndef RunI_ProtonMC_h
#define RunI_ProtonMC_h
...
public :
   ...
   RunI_ProtonMC(TTree *tree=0);
   virtual ~RunI_ProtonMC();
...
#ifdef RunI_ProtonMC_cxx
RunI_ProtonMC::RunI_ProtonMC(TTree *tree) : fChain(0) 
{
...
RunI_ProtonMC::~RunI_ProtonMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RunI_ProtonMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RunI_ProtonMC::LoadTree(Long64_t entry)
{
...
void RunI_ProtonMC::Init(TTree *tree)
{
...
void RunI_ProtonMC::Show(Long64_t entry)
{
...
Int_t RunI_ProtonMC::Cut(Long64_t entry)
{
