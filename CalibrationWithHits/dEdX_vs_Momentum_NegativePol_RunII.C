...
//TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_DefaultCollection_ThroughGoing.root");
//TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_0.051Collection_ThroughGoing.root");
//TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_0.050Collection_ThroughGoing.root");

// #######################
// ### Induction Plane ###
// #######################
//TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_DefaultInduction_ThroughGoing.root");
//TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_0.0507Induction_ThroughGoing.root");
//TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_0.0520Induction_ThroughGoing.root");
//TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_0.0560Induction_ThroughGoing.root");
//TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_0.0580Induction_ThroughGoing.root");
TFile *f1 = new TFile("./TJCalibrationMethod_RunIINegPol_0.0605Induction_ThroughGoing.root");
