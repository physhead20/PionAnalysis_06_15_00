...
// Wed May 31 12:19:02 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PionRunI_DDMC_AnaTree.root
//////////////////////////////////////////////////////////

#ifndef RunI_PionNegMC_h
#define RunI_PionNegMC_h
...
public :
   ...
   RunI_PionNegMC(TTree *tree=0);
   virtual ~RunI_PionNegMC();
...
#ifdef RunI_PionNegMC_cxx
RunI_PionNegMC::RunI_PionNegMC(TTree *tree) : fChain(0) 
{
...
RunI_PionNegMC::~RunI_PionNegMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RunI_PionNegMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RunI_PionNegMC::LoadTree(Long64_t entry)
{
...
void RunI_PionNegMC::Init(TTree *tree)
{
...
void RunI_PionNegMC::Show(Long64_t entry)
{
...
Int_t RunI_PionNegMC::Cut(Long64_t entry)
{
...
#endif // #ifdef RunI_PionNegMC_cxx
