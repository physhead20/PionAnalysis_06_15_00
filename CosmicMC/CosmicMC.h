...
// Sat Feb 11 08:00:58 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/CosmicsMC.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[24];   //[nclus]
   Double_t        clusterttick[24];   //[nclus]
   Double_t        cluendwire[24];   //[nclus]
   Double_t        cluendtick[24];   //[nclus]
   Int_t           cluplane[24];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[373];   //[nhits]
   Int_t           hit_wire[373];   //[nhits]
   Int_t           hit_channel[373];   //[nhits]
   Double_t        hit_peakT[373];   //[nhits]
   Double_t        hit_charge[373];   //[nhits]
   Double_t        hit_ph[373];   //[nhits]
   Double_t        hit_tstart[373];   //[nhits]
   Double_t        hit_tend[373];   //[nhits]
   Int_t           hit_trkid[373];   //[nhits]
   Int_t           hit_trkkey[373];   //[nhits]
   Int_t           hit_clukey[373];   //[nhits]
   Int_t           hit_pk[373];   //[nhits]
   Int_t           hit_t[373];   //[nhits]
   Int_t           hit_ch[373];   //[nhits]
   Int_t           hit_fwhh[373];   //[nhits]
   Double_t        hit_rms[373];   //[nhits]
   Double_t        hit_nelec[373];   //[nhits]
   Double_t        hit_energy[373];   //[nhits]
   Float_t         hit_dQds[373];   //[nhits]
   Float_t         hit_dEds[373];   //[nhits]
   Float_t         hit_ds[373];   //[nhits]
   Float_t         hit_resrange[373];   //[nhits]
   Float_t         hit_x[373];   //[nhits]
   Float_t         hit_y[373];   //[nhits]
   Float_t         hit_z[373];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[1577];   //[maxTrackIDE]
   Double_t        IDEPos[1577][3];   //[maxTrackIDE]
   Int_t           no_primaries;
...
#ifdef CosmicMC_cxx
CosmicMC::CosmicMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/CosmicsMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/CosmicsMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/CosmicsMC.root:/anatree");
...
Int_t CosmicMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CosmicMC::LoadTree(Long64_t entry)
{
...
void CosmicMC::Show(Long64_t entry)
{
...
Int_t CosmicMC::Cut(Long64_t entry)
{
