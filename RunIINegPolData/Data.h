...
// Sat Feb 11 05:08:55 2017 by ROOT version 6.06/08
// from TTree anatree/analysis tree
// found on file: RunIINegPol_AnaTree_06_15_00.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[1047];   //[nclus]
   Double_t        clusterttick[1047];   //[nclus]
   Double_t        cluendwire[1047];   //[nclus]
   Double_t        cluendtick[1047];   //[nclus]
   Int_t           cluplane[1047];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[312];   //[ntracks_reco]
   Double_t        trkvtxy[312];   //[ntracks_reco]
   Double_t        trkvtxz[312];   //[ntracks_reco]
   Double_t        trkendx[312];   //[ntracks_reco]
   Double_t        trkendy[312];   //[ntracks_reco]
   Double_t        trkendz[312];   //[ntracks_reco]
   Double_t        trkstartdcosx[312];   //[ntracks_reco]
   Double_t        trkstartdcosy[312];   //[ntracks_reco]
   Double_t        trkstartdcosz[312];   //[ntracks_reco]
   Double_t        trkenddcosx[312];   //[ntracks_reco]
   Double_t        trkenddcosy[312];   //[ntracks_reco]
   Double_t        trkenddcosz[312];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[312];   //[ntracks_reco]
   Double_t        trklength[312];   //[ntracks_reco]
   Double_t        trkmomrange[312];   //[ntracks_reco]
   Double_t        trkmommschi2[312];   //[ntracks_reco]
   Double_t        trkmommsllhd[312];   //[ntracks_reco]
   Int_t           ntrkhits[312];   //[ntracks_reco]
   Double_t        trkx[312][1000];   //[ntracks_reco]
   Double_t        trky[312][1000];   //[ntracks_reco]
   Double_t        trkz[312][1000];   //[ntracks_reco]
   Double_t        trkpitch[312][2];   //[ntracks_reco]
   Int_t           trkhits[312][2];   //[ntracks_reco]
   Double_t        trkdedx[312][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[312][2][1000];   //[ntracks_reco]
   Double_t        trkrr[312][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[312][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[312][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[312][2];   //[ntracks_reco]
   Double_t        trkpida[312][2];   //[ntracks_reco]
   Int_t           nTrajPoint[312];   //[ntracks_reco]
   Double_t        pHat0_X[312][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[312][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[312][1000];   //[ntracks_reco]
   Double_t        trjPt_X[312][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[312][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[312][1000];   //[ntracks_reco]
   Int_t           trkg4id[312];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[39876];   //[nhits]
   Int_t           hit_wire[39876];   //[nhits]
   Int_t           hit_channel[39876];   //[nhits]
   Double_t        hit_peakT[39876];   //[nhits]
   Double_t        hit_charge[39876];   //[nhits]
   Double_t        hit_ph[39876];   //[nhits]
   Double_t        hit_tstart[39876];   //[nhits]
   Double_t        hit_tend[39876];   //[nhits]
   Int_t           hit_trkid[39876];   //[nhits]
   Int_t           hit_trkkey[39876];   //[nhits]
   Int_t           hit_clukey[39876];   //[nhits]
   Int_t           hit_pk[39876];   //[nhits]
   Int_t           hit_t[39876];   //[nhits]
   Int_t           hit_ch[39876];   //[nhits]
   Int_t           hit_fwhh[39876];   //[nhits]
   Double_t        hit_rms[39876];   //[nhits]
   Double_t        hit_nelec[39876];   //[nhits]
   Double_t        hit_energy[39876];   //[nhits]
   Float_t         hit_dQds[39876];   //[nhits]
   Float_t         hit_dEds[39876];   //[nhits]
   Float_t         hit_ds[39876];   //[nhits]
   Float_t         hit_resrange[39876];   //[nhits]
   Float_t         hit_x[39876];   //[nhits]
   Float_t         hit_y[39876];   //[nhits]
   Float_t         hit_z[39876];   //[nhits]
   Int_t           nwctrks;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("RunIINegPol_AnaTree_06_15_00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("RunIINegPol_AnaTree_06_15_00.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("RunIINegPol_AnaTree_06_15_00.root:/anatree");
