...
// Tue May 23 13:47:45 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/ProtonRunI_DDMC_AnaTree.root
//////////////////////////////////////////////////////////

#ifndef ProtonMC_ThroughGoingTrack_h
#define ProtonMC_ThroughGoingTrack_h
...
class ProtonMC_ThroughGoingTrack {
public :
   ...
   ProtonMC_ThroughGoingTrack(TTree *tree=0);
   virtual ~ProtonMC_ThroughGoingTrack();
...
#ifdef ProtonMC_ThroughGoingTrack_cxx
ProtonMC_ThroughGoingTrack::ProtonMC_ThroughGoingTrack(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/ProtonRunI_DDMC_AnaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/ProtonRunI_DDMC_AnaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/ProtonRunI_DDMC_AnaTree.root:/anatree");
...
ProtonMC_ThroughGoingTrack::~ProtonMC_ThroughGoingTrack()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ProtonMC_ThroughGoingTrack::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ProtonMC_ThroughGoingTrack::LoadTree(Long64_t entry)
{
...
void ProtonMC_ThroughGoingTrack::Init(TTree *tree)
{
...
Bool_t ProtonMC_ThroughGoingTrack::Notify()
{
...
void ProtonMC_ThroughGoingTrack::Show(Long64_t entry)
{
...
Int_t ProtonMC_ThroughGoingTrack::Cut(Long64_t entry)
{
...
#endif // #ifdef ProtonMC_ThroughGoingTrack_cxx
