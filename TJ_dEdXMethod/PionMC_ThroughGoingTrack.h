...
// Tue May 23 13:01:58 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PionRunI_DDMC_AnaTree.root
//////////////////////////////////////////////////////////

#ifndef PionMC_ThroughGoingTrack_h
#define PionMC_ThroughGoingTrack_h
...
class PionMC_ThroughGoingTrack {
public :
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1084];   //[nhits]
   Int_t           hit_wire[1084];   //[nhits]
   Int_t           hit_channel[1084];   //[nhits]
   Double_t        hit_peakT[1084];   //[nhits]
   Double_t        hit_charge[1084];   //[nhits]
   Double_t        hit_ph[1084];   //[nhits]
   Double_t        hit_tstart[1084];   //[nhits]
   Double_t        hit_tend[1084];   //[nhits]
   Int_t           hit_trkid[1084];   //[nhits]
   Int_t           hit_trkkey[1084];   //[nhits]
   Int_t           hit_clukey[1084];   //[nhits]
   Int_t           hit_pk[1084];   //[nhits]
   Int_t           hit_t[1084];   //[nhits]
   Int_t           hit_ch[1084];   //[nhits]
   Int_t           hit_fwhh[1084];   //[nhits]
   Double_t        hit_rms[1084];   //[nhits]
   Double_t        hit_nelec[1084];   //[nhits]
   Double_t        hit_energy[1084];   //[nhits]
   Float_t         hit_dQds[1084];   //[nhits]
   Float_t         hit_dEds[1084];   //[nhits]
   Float_t         hit_ds[1084];   //[nhits]
   Float_t         hit_resrange[1084];   //[nhits]
   Float_t         hit_x[1084];   //[nhits]
   Float_t         hit_y[1084];   //[nhits]
   Float_t         hit_z[1084];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[4348];   //[maxTrackIDE]
   Double_t        IDEPos[4348][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[281];   //[geant_list_size]
   Double_t        Eng[281];   //[geant_list_size]
   Double_t        Px[281];   //[geant_list_size]
   Double_t        Py[281];   //[geant_list_size]
   Double_t        Pz[281];   //[geant_list_size]
   Double_t        EndEng[281];   //[geant_list_size]
   Double_t        EndPx[281];   //[geant_list_size]
   Double_t        EndPy[281];   //[geant_list_size]
   Double_t        EndPz[281];   //[geant_list_size]
   Double_t        StartPointx[281];   //[geant_list_size]
   Double_t        StartPointy[281];   //[geant_list_size]
   Double_t        StartPointz[281];   //[geant_list_size]
   Double_t        EndPointx[281];   //[geant_list_size]
   Double_t        EndPointy[281];   //[geant_list_size]
   Double_t        EndPointz[281];   //[geant_list_size]
   Int_t           Process[281];   //[geant_list_size]
   Int_t           NumberDaughters[281];   //[geant_list_size]
   Int_t           Mother[281];   //[geant_list_size]
   Int_t           TrackId[281];   //[geant_list_size]
   Int_t           process_primary[281];   //[geant_list_size]
   ...
   PionMC_ThroughGoingTrack(TTree *tree=0);
   virtual ~PionMC_ThroughGoingTrack();
...
#ifdef PionMC_ThroughGoingTrack_cxx
PionMC_ThroughGoingTrack::PionMC_ThroughGoingTrack(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PionRunI_DDMC_AnaTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PionRunI_DDMC_AnaTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PionRunI_DDMC_AnaTree.root:/anatree");
...
PionMC_ThroughGoingTrack::~PionMC_ThroughGoingTrack()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PionMC_ThroughGoingTrack::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PionMC_ThroughGoingTrack::LoadTree(Long64_t entry)
{
...
void PionMC_ThroughGoingTrack::Init(TTree *tree)
{
...
Bool_t PionMC_ThroughGoingTrack::Notify()
{
...
void PionMC_ThroughGoingTrack::Show(Long64_t entry)
{
...
Int_t PionMC_ThroughGoingTrack::Cut(Long64_t entry)
{
...
#endif // #ifdef PionMC_ThroughGoingTrack_cxx
