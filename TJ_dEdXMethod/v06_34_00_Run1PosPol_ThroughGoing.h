...
// Thu May 25 12:55:40 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/PickyTrack_PiMuE_PosPol_Reco_v06_34_01_anatree.root
//////////////////////////////////////////////////////////

#ifndef v06_34_00_Run1PosPol_ThroughGoing_h
#define v06_34_00_Run1PosPol_ThroughGoing_h
...
class v06_34_00_Run1PosPol_ThroughGoing {
public :
   ...
   v06_34_00_Run1PosPol_ThroughGoing(TTree *tree=0);
   virtual ~v06_34_00_Run1PosPol_ThroughGoing();
...
#ifdef v06_34_00_Run1PosPol_ThroughGoing_cxx
v06_34_00_Run1PosPol_ThroughGoing::v06_34_00_Run1PosPol_ThroughGoing(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/PickyTrack_PiMuE_PosPol_Reco_v06_34_01_anatree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/PickyTrack_PiMuE_PosPol_Reco_v06_34_01_anatree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/PickyTrack_PiMuE_PosPol_Reco_v06_34_01_anatree.root:/anatree");
...
v06_34_00_Run1PosPol_ThroughGoing::~v06_34_00_Run1PosPol_ThroughGoing()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t v06_34_00_Run1PosPol_ThroughGoing::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t v06_34_00_Run1PosPol_ThroughGoing::LoadTree(Long64_t entry)
{
...
void v06_34_00_Run1PosPol_ThroughGoing::Init(TTree *tree)
{
...
Bool_t v06_34_00_Run1PosPol_ThroughGoing::Notify()
{
...
void v06_34_00_Run1PosPol_ThroughGoing::Show(Long64_t entry)
{
...
Int_t v06_34_00_Run1PosPol_ThroughGoing::Cut(Long64_t entry)
{
...
#endif // #ifdef v06_34_00_Run1PosPol_ThroughGoing_cxx
