...
// Mon May 22 08:33:37 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/RunINegPol_AnaTree_06_15_00.root
//////////////////////////////////////////////////////////

#ifndef RunI_NegPol_ThroughGoingTrack_h
#define RunI_NegPol_ThroughGoingTrack_h
...
class RunI_NegPol_ThroughGoingTrack {
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[625];   //[nclus]
   Double_t        clusterttick[625];   //[nclus]
   Double_t        cluendwire[625];   //[nclus]
   Double_t        cluendtick[625];   //[nclus]
   Int_t           cluplane[625];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[140];   //[ntracks_reco]
   Double_t        trkvtxy[140];   //[ntracks_reco]
   Double_t        trkvtxz[140];   //[ntracks_reco]
   Double_t        trkendx[140];   //[ntracks_reco]
   Double_t        trkendy[140];   //[ntracks_reco]
   Double_t        trkendz[140];   //[ntracks_reco]
   Double_t        trkstartdcosx[140];   //[ntracks_reco]
   Double_t        trkstartdcosy[140];   //[ntracks_reco]
   Double_t        trkstartdcosz[140];   //[ntracks_reco]
   Double_t        trkenddcosx[140];   //[ntracks_reco]
   Double_t        trkenddcosy[140];   //[ntracks_reco]
   Double_t        trkenddcosz[140];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[140];   //[ntracks_reco]
   Double_t        trklength[140];   //[ntracks_reco]
   Double_t        trkmomrange[140];   //[ntracks_reco]
   Double_t        trkmommschi2[140];   //[ntracks_reco]
   Double_t        trkmommsllhd[140];   //[ntracks_reco]
   Int_t           ntrkhits[140];   //[ntracks_reco]
   Double_t        trkx[140][1000];   //[ntracks_reco]
   Double_t        trky[140][1000];   //[ntracks_reco]
   Double_t        trkz[140][1000];   //[ntracks_reco]
   Double_t        trkpitch[140][2];   //[ntracks_reco]
   Int_t           trkhits[140][2];   //[ntracks_reco]
   Double_t        trkdedx[140][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[140][2][1000];   //[ntracks_reco]
   Double_t        trkrr[140][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[140][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[140][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[140][2];   //[ntracks_reco]
   Double_t        trkpida[140][2];   //[ntracks_reco]
   Int_t           nTrajPoint[140];   //[ntracks_reco]
   Double_t        pHat0_X[140][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[140][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[140][1000];   //[ntracks_reco]
   Double_t        trjPt_X[140][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[140][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[140][1000];   //[ntracks_reco]
   Int_t           trkg4id[140];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[16393];   //[nhits]
   Int_t           hit_wire[16393];   //[nhits]
   Int_t           hit_channel[16393];   //[nhits]
   Double_t        hit_peakT[16393];   //[nhits]
   Double_t        hit_charge[16393];   //[nhits]
   Double_t        hit_ph[16393];   //[nhits]
   Double_t        hit_tstart[16393];   //[nhits]
   Double_t        hit_tend[16393];   //[nhits]
   Int_t           hit_trkid[16393];   //[nhits]
   Int_t           hit_trkkey[16393];   //[nhits]
   Int_t           hit_clukey[16393];   //[nhits]
   Int_t           hit_pk[16393];   //[nhits]
   Int_t           hit_t[16393];   //[nhits]
   Int_t           hit_ch[16393];   //[nhits]
   Int_t           hit_fwhh[16393];   //[nhits]
   Double_t        hit_rms[16393];   //[nhits]
   Double_t        hit_nelec[16393];   //[nhits]
   Double_t        hit_energy[16393];   //[nhits]
   Float_t         hit_dQds[16393];   //[nhits]
   Float_t         hit_dEds[16393];   //[nhits]
   Float_t         hit_ds[16393];   //[nhits]
   Float_t         hit_resrange[16393];   //[nhits]
   Float_t         hit_x[16393];   //[nhits]
   Float_t         hit_y[16393];   //[nhits]
   Float_t         hit_z[16393];   //[nhits]
   Int_t           nwctrks;
   ...
   RunI_NegPol_ThroughGoingTrack(TTree *tree=0);
   virtual ~RunI_NegPol_ThroughGoingTrack();
...
#ifdef RunI_NegPol_ThroughGoingTrack_cxx
RunI_NegPol_ThroughGoingTrack::RunI_NegPol_ThroughGoingTrack(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/RunINegPol_AnaTree_06_15_00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/RunINegPol_AnaTree_06_15_00.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/RunINegPol_AnaTree_06_15_00.root:/anatree");
...
RunI_NegPol_ThroughGoingTrack::~RunI_NegPol_ThroughGoingTrack()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RunI_NegPol_ThroughGoingTrack::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RunI_NegPol_ThroughGoingTrack::LoadTree(Long64_t entry)
{
...
void RunI_NegPol_ThroughGoingTrack::Init(TTree *tree)
{
...
Bool_t RunI_NegPol_ThroughGoingTrack::Notify()
{
...
void RunI_NegPol_ThroughGoingTrack::Show(Long64_t entry)
{
...
Int_t RunI_NegPol_ThroughGoingTrack::Cut(Long64_t entry)
{
...
#endif // #ifdef RunI_NegPol_ThroughGoingTrack_cxx
