#define RunI_PosPol_ThroughGoingTrack_cxx
#include "RunI_PosPol_ThroughGoingTrack.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void RunI_PosPol_ThroughGoingTrack::Loop()
{
if (fChain == 0) return;
...
TFile myfile("./TJCalibrationMethod_RunIPosPol_Proton_Induction.root","RECREATE");
