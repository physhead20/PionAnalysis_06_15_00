#define RunI_NegPol_ThroughGoingTrack_cxx
#include "RunI_NegPol_ThroughGoingTrack.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void RunI_NegPol_ThroughGoingTrack::Loop()
{
if (fChain == 0) return;
...
TFile myfile("./TJCalibrationMethod_RunINegPol_ThroughGoing_Collection.root","RECREATE");
