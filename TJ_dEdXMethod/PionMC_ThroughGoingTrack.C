#define PionMC_ThroughGoingTrack_cxx
#include "PionMC_ThroughGoingTrack.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
...
void PionMC_ThroughGoingTrack::Loop()
{
if (fChain == 0) return;
...
TFile myfile("./TJCalibrationMethod_PionMC_RunI_ThroughGoing_Collection.root","RECREATE");
