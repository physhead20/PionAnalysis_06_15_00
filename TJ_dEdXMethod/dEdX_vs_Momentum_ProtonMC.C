...
double ProtonMomentum[42] = {365.079, 383.283, 400.821, 433.899, 464.979, 494.283,
                             522.144, 574.647, 623.376, 691.53, 755.022, 853.146, 944.499, 1030.635, 1113.33, 1192.14, 1268.73, 1343.1,
...
double ProtonMomentumError[42] = {0.};

double ProtonTheorydEdX[42] = {9.635, 8.949, 8.368, 7.435, 6.719, 6.15, 5.687
                               4.979, 4.461, 3.902, 3.502, 3.042, 2.731, 2.508, 2.34, 2.21, 2.107, 2.023, 1.954, 1.848, 1.771, 1.713, 1.67, 
                               1.609, 1.57, 1.536, 1.519, 1.508, 1.51, 1.51, 1.517, 1.526, 1.537, 1.548, 1.559, 1.57, 1.591, 1.61, 1.628, 
                               1.645, 1.675, 1.7};
			 
double ProtonTheorydEdXError[42] = {0.};
...
//TFile *f1 = new TFile("./TJCalibrationMethod_ProtonMC_ThroughGoing_Collection.root");
TFile *f1 = new TFile("./TJCalibrationMethod_RunIPosPol_Proton_Induction.root");
...
h150_200->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h200_250->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h250_300->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h300_350->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h350_400->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h400_450->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h450_500->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h500_550->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h550_600->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h600_650->Fit(data_gaus,"R+0LLi","0",5, 12.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h650_700->Fit(data_gaus,"R+0LLi","0",4, 6.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h700_750->Fit(data_gaus,"R+0LLi","0",4, 6.75);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h750_800->Fit(data_gaus,"R+0LLi","0",3, 7.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h800_850->Fit(data_gaus,"R+0LLi","0",3, 7.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h850_900->Fit(data_gaus,"R+0LLi","0",2.5, 4.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h900_950->Fit(data_gaus,"R+0LLi","0",2.5, 4.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h950_1000->Fit(data_gaus,"R+0LLi","0",2.5, 4.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h1000_1050->Fit(data_gaus,"R+0LLi","0",2.5, 4.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h1050_1100->Fit(data_gaus,"R+0LLi","0",2.5, 4.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h1100_1150->Fit(data_gaus,"R+0LLi","0",2.5, 4.25);
...
TF1 *data_gaus = new TF1("data_gaus","gaus",0, 50);
// ### Fitting the data dE/dX peak with Gaussian ###
h1150_1200->Fit(data_gaus,"R+0LLi","0",2.5, 4.25);
...
grFullBin->SetLineColor(kAzure+1);
