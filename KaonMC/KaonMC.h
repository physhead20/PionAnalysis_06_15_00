...
// Sat Feb 11 06:47:29 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/KaonMinusMC_06_15_00.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[101];   //[nclus]
   Double_t        clusterttick[101];   //[nclus]
   Double_t        cluendwire[101];   //[nclus]
   Double_t        cluendtick[101];   //[nclus]
   Int_t           cluplane[101];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[30];   //[ntracks_reco]
   Double_t        trkvtxy[30];   //[ntracks_reco]
   Double_t        trkvtxz[30];   //[ntracks_reco]
   Double_t        trkendx[30];   //[ntracks_reco]
   Double_t        trkendy[30];   //[ntracks_reco]
   Double_t        trkendz[30];   //[ntracks_reco]
   Double_t        trkstartdcosx[30];   //[ntracks_reco]
   Double_t        trkstartdcosy[30];   //[ntracks_reco]
   Double_t        trkstartdcosz[30];   //[ntracks_reco]
   Double_t        trkenddcosx[30];   //[ntracks_reco]
   Double_t        trkenddcosy[30];   //[ntracks_reco]
   Double_t        trkenddcosz[30];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[30];   //[ntracks_reco]
   Double_t        trklength[30];   //[ntracks_reco]
   Double_t        trkmomrange[30];   //[ntracks_reco]
   Double_t        trkmommschi2[30];   //[ntracks_reco]
   Double_t        trkmommsllhd[30];   //[ntracks_reco]
   Int_t           ntrkhits[30];   //[ntracks_reco]
   Double_t        trkx[30][1000];   //[ntracks_reco]
   Double_t        trky[30][1000];   //[ntracks_reco]
   Double_t        trkz[30][1000];   //[ntracks_reco]
   Double_t        trkpitch[30][2];   //[ntracks_reco]
   Int_t           trkhits[30][2];   //[ntracks_reco]
   Double_t        trkdedx[30][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[30][2][1000];   //[ntracks_reco]
   Double_t        trkrr[30][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[30][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[30][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[30][2];   //[ntracks_reco]
   Double_t        trkpida[30][2];   //[ntracks_reco]
   Int_t           nTrajPoint[30];   //[ntracks_reco]
   Double_t        pHat0_X[30][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[30][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[30][1000];   //[ntracks_reco]
   Double_t        trjPt_X[30][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[30][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[30][1000];   //[ntracks_reco]
   Int_t           trkg4id[30];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1574];   //[nhits]
   Int_t           hit_wire[1574];   //[nhits]
   Int_t           hit_channel[1574];   //[nhits]
   Double_t        hit_peakT[1574];   //[nhits]
   Double_t        hit_charge[1574];   //[nhits]
   Double_t        hit_ph[1574];   //[nhits]
   Double_t        hit_tstart[1574];   //[nhits]
   Double_t        hit_tend[1574];   //[nhits]
   Int_t           hit_trkid[1574];   //[nhits]
   Int_t           hit_trkkey[1574];   //[nhits]
   Int_t           hit_clukey[1574];   //[nhits]
   Int_t           hit_pk[1574];   //[nhits]
   Int_t           hit_t[1574];   //[nhits]
   Int_t           hit_ch[1574];   //[nhits]
   Int_t           hit_fwhh[1574];   //[nhits]
   Double_t        hit_rms[1574];   //[nhits]
   Double_t        hit_nelec[1574];   //[nhits]
   Double_t        hit_energy[1574];   //[nhits]
   Float_t         hit_dQds[1574];   //[nhits]
   Float_t         hit_dEds[1574];   //[nhits]
   Float_t         hit_ds[1574];   //[nhits]
   Float_t         hit_resrange[1574];   //[nhits]
   Float_t         hit_x[1574];   //[nhits]
   Float_t         hit_y[1574];   //[nhits]
   Float_t         hit_z[1574];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[4069];   //[maxTrackIDE]
   Double_t        IDEPos[4069][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[414];   //[geant_list_size]
   Double_t        Eng[414];   //[geant_list_size]
   Double_t        Px[414];   //[geant_list_size]
   Double_t        Py[414];   //[geant_list_size]
   Double_t        Pz[414];   //[geant_list_size]
   Double_t        EndEng[414];   //[geant_list_size]
   Double_t        EndPx[414];   //[geant_list_size]
   Double_t        EndPy[414];   //[geant_list_size]
   Double_t        EndPz[414];   //[geant_list_size]
   Double_t        StartPointx[414];   //[geant_list_size]
   Double_t        StartPointy[414];   //[geant_list_size]
   Double_t        StartPointz[414];   //[geant_list_size]
   Double_t        EndPointx[414];   //[geant_list_size]
   Double_t        EndPointy[414];   //[geant_list_size]
   Double_t        EndPointz[414];   //[geant_list_size]
   Int_t           Process[414];   //[geant_list_size]
   Int_t           NumberDaughters[414];   //[geant_list_size]
   Int_t           Mother[414];   //[geant_list_size]
   Int_t           TrackId[414];   //[geant_list_size]
   Int_t           process_primary[414];   //[geant_list_size]
...
#ifdef KaonMC_cxx
KaonMC::KaonMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/KaonMinusMC_06_15_00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/KaonMinusMC_06_15_00.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/KaonMinusMC_06_15_00.root:/anatree");
...
Int_t KaonMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t KaonMC::LoadTree(Long64_t entry)
{
...
void KaonMC::Show(Long64_t entry)
{
...
Int_t KaonMC::Cut(Long64_t entry)
{
