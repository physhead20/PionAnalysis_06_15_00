...
// Sat Feb 11 06:44:43 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/ElectronMC.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[112];   //[nclus]
   Double_t        clusterttick[112];   //[nclus]
   Double_t        cluendwire[112];   //[nclus]
   Double_t        cluendtick[112];   //[nclus]
   Int_t           cluplane[112];   //[nclus]
   Int_t           ntracks_reco;
   ...
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[1749];   //[nhits]
   Int_t           hit_wire[1749];   //[nhits]
   Int_t           hit_channel[1749];   //[nhits]
   Double_t        hit_peakT[1749];   //[nhits]
   Double_t        hit_charge[1749];   //[nhits]
   Double_t        hit_ph[1749];   //[nhits]
   Double_t        hit_tstart[1749];   //[nhits]
   Double_t        hit_tend[1749];   //[nhits]
   Int_t           hit_trkid[1749];   //[nhits]
   Int_t           hit_trkkey[1749];   //[nhits]
   Int_t           hit_clukey[1749];   //[nhits]
   Int_t           hit_pk[1749];   //[nhits]
   Int_t           hit_t[1749];   //[nhits]
   Int_t           hit_ch[1749];   //[nhits]
   Int_t           hit_fwhh[1749];   //[nhits]
   Double_t        hit_rms[1749];   //[nhits]
   Double_t        hit_nelec[1749];   //[nhits]
   Double_t        hit_energy[1749];   //[nhits]
   Float_t         hit_dQds[1749];   //[nhits]
   Float_t         hit_dEds[1749];   //[nhits]
   Float_t         hit_ds[1749];   //[nhits]
   Float_t         hit_resrange[1749];   //[nhits]
   Float_t         hit_x[1749];   //[nhits]
   Float_t         hit_y[1749];   //[nhits]
   Float_t         hit_z[1749];   //[nhits]
   Int_t           nwctrks;
   ...
   Int_t           maxTrackIDE;
   Double_t        IDEEnergy[2845];   //[maxTrackIDE]
   Double_t        IDEPos[2845][3];   //[maxTrackIDE]
   Int_t           no_primaries;
   Int_t           geant_list_size;
   Int_t           pdg[3165];   //[geant_list_size]
   Double_t        Eng[3165];   //[geant_list_size]
   Double_t        Px[3165];   //[geant_list_size]
   Double_t        Py[3165];   //[geant_list_size]
   Double_t        Pz[3165];   //[geant_list_size]
   Double_t        EndEng[3165];   //[geant_list_size]
   Double_t        EndPx[3165];   //[geant_list_size]
   Double_t        EndPy[3165];   //[geant_list_size]
   Double_t        EndPz[3165];   //[geant_list_size]
   Double_t        StartPointx[3165];   //[geant_list_size]
   Double_t        StartPointy[3165];   //[geant_list_size]
   Double_t        StartPointz[3165];   //[geant_list_size]
   Double_t        EndPointx[3165];   //[geant_list_size]
   Double_t        EndPointy[3165];   //[geant_list_size]
   Double_t        EndPointz[3165];   //[geant_list_size]
   Int_t           Process[3165];   //[geant_list_size]
   Int_t           NumberDaughters[3165];   //[geant_list_size]
   Int_t           Mother[3165];   //[geant_list_size]
   Int_t           TrackId[3165];   //[geant_list_size]
   Int_t           process_primary[3165];   //[geant_list_size]
...
#ifdef ElectronMC_cxx
ElectronMC::ElectronMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../ROOTFILES/ElectronMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../ROOTFILES/ElectronMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../ROOTFILES/ElectronMC.root:/anatree");
...
ElectronMC::~ElectronMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ElectronMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ElectronMC::LoadTree(Long64_t entry)
{
...
void ElectronMC::Init(TTree *tree)
{
...
void ElectronMC::Show(Long64_t entry)
{
...
Int_t ElectronMC::Cut(Long64_t entry)
{
