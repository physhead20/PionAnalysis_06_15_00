...
// Thu May  4 13:36:38 2017 by ROOT version 5.34/36
// from TTree anatree/analysis tree
// found on file: ../ROOTFILES/RunINegPol_AnaTree_06_15_00.root
//////////////////////////////////////////////////////////

#ifndef TingjunMethod_h
#define TingjunMethod_h
...
public :
   ...
   TingjunMethod(TTree *tree=0);
   virtual ~TingjunMethod();
...
#ifdef TingjunMethod_cxx
TingjunMethod::TingjunMethod(TTree *tree) : fChain(0) 
{
...
TingjunMethod::~TingjunMethod()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TingjunMethod::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TingjunMethod::LoadTree(Long64_t entry)
{
...
void TingjunMethod::Init(TTree *tree)
{
...
void TingjunMethod::Show(Long64_t entry)
{
...
Int_t TingjunMethod::Cut(Long64_t entry)
{
